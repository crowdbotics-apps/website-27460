...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_191_128}>
        <View style={styles.View_191_129}>
          <View style={styles.View_191_130}>
            <Text style={styles.Text_191_130}>Site Coordinator</Text>
          </View>
        </View>
        <View style={styles.View_191_131}>
          <View style={styles.View_191_132}>
            <Text style={styles.Text_191_132}>Security Assesment Report</Text>
          </View>
        </View>
        <View style={styles.View_191_133}>
          <View style={styles.View_191_134}>
            <Text style={styles.Text_191_134}>Desain SOP</Text>
          </View>
        </View>
        <View style={styles.View_191_135}>
          <View style={styles.View_191_136}>
            <Text style={styles.Text_191_136}>
              Security Self Audit Assement{" "}
            </Text>
          </View>
        </View>
        <View style={styles.View_191_137}>
          <View style={styles.View_191_138}>
            <View style={styles.View_191_139}>
              <Text style={styles.Text_191_139}>Controller</Text>
            </View>
          </View>
        </View>
        <View style={styles.View_191_140}>
          <View style={styles.View_191_141}>
            <Text style={styles.Text_191_141}>Operational Visit</Text>
          </View>
        </View>
        <View style={styles.View_191_142}>
          <View style={styles.View_191_143}>
            <Text style={styles.Text_191_143}>
              Perfomance Management Review
            </Text>
          </View>
        </View>
        <View style={styles.View_191_144}>
          <View style={styles.View_191_145}>
            <View style={styles.View_191_146}>
              <Text style={styles.Text_191_146}>Additional Personal</Text>
            </View>
          </View>
        </View>
        <View style={styles.View_191_147}>
          <View style={styles.View_191_148}>
            <Text style={styles.Text_191_148}>Reliever</Text>
          </View>
        </View>
        <View style={styles.View_191_149}>
          <View style={styles.View_191_150}>
            <Text style={styles.Text_191_150}>Training Reguler</Text>
          </View>
        </View>
        <View style={styles.View_191_151}>
          <View style={styles.View_191_152}>
            <Text style={styles.Text_191_152}>Optional Service</Text>
          </View>
        </View>
        <View style={styles.View_191_153}>
          <View style={styles.View_191_154}>
            <Text style={styles.Text_191_154}>Shelter Digital</Text>
          </View>
        </View>
      </View>
    </ScrollView>
