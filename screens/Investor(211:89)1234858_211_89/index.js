...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_211_91}>
        <View style={styles.View_211_92}>
          <Text style={styles.Text_211_92}>Laporan Tahunan</Text>
        </View>
      </View>
      <View style={styles.View_211_93}>
        <View style={styles.View_211_94}>
          <Text style={styles.Text_211_94}>Informasi Keuangan</Text>
        </View>
      </View>
      <View style={styles.View_211_95}>
        <View style={styles.View_211_96}>
          <Text style={styles.Text_211_96}>Persentasi Perusahaan</Text>
        </View>
      </View>
      <View style={styles.View_211_97}>
        <View style={styles.View_211_98}>
          <Text style={styles.Text_211_98}>Informasi Pemegang Saham</Text>
        </View>
      </View>
    </ScrollView>
  )
