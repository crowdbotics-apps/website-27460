    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_211_111}>
        <View style={styles.View_211_112}>
          <Text style={styles.Text_211_112}>Laporan Tahunan</Text>
        </View>
      </View>
      <View style={styles.View_211_113}>
        <View style={styles.View_211_114}>
          <Text style={styles.Text_211_114}>Informasi Keuangan</Text>
        </View>
      </View>
      <View style={styles.View_211_115}>
        <View style={styles.View_211_116}>
          <Text style={styles.Text_211_116}>Persentasi Perusahaan</Text>
        </View>
      </View>
      <View style={styles.View_211_117}>
        <View style={styles.View_211_118}>
          <Text style={styles.Text_211_118}>Informasi Pemegang Saham</Text>
        </View>
      </View>
    </ScrollView>
  )
