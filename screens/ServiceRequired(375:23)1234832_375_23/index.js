...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_375_24}>
        <View style={styles.View_375_25}>
          <Text style={styles.Text_375_25}>Satuan Pengamanan (Satpam)</Text>
        </View>
      </View>
      <View style={styles.View_375_26}>
        <View style={styles.View_375_27}>
          <Text style={styles.Text_375_27}>
            Pelatihan Satuan Pengamanan (Satpam)
          </Text>
        </View>
      </View>
      <View style={styles.View_375_28}>
        <View style={styles.View_375_29}>
          <Text style={styles.Text_375_29}>Pemborongan</Text>
        </View>
      </View>
      <View style={styles.View_375_30}>
        <View style={styles.View_375_31}>
          <Text style={styles.Text_375_31}>Pengamanan Digital</Text>
        </View>
      </View>
      <View style={styles.View_375_32}>
        <View style={styles.View_375_33}>
          <Text style={styles.Text_375_33}>Cleaning Service</Text>
        </View>
      </View>
      <View style={styles.View_375_34}>
        <View style={styles.View_375_35}>
          <Text style={styles.Text_375_35}>Lainnya</Text>
        </View>
      </View>
    </ScrollView>
  )
