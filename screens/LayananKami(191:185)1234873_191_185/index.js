...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_191_188}>
        <View style={styles.View_191_189}>
          <View style={styles.View_191_190}>
            <Text style={styles.Text_191_190}>Site Coordinator</Text>
          </View>
        </View>
        <View style={styles.View_191_191}>
          <View style={styles.View_191_192}>
            <Text style={styles.Text_191_192}>Security Assesment Report</Text>
          </View>
        </View>
        <View style={styles.View_191_193}>
          <View style={styles.View_191_194}>
            <Text style={styles.Text_191_194}>Desain SOP</Text>
          </View>
        </View>
        <View style={styles.View_191_195}>
          <View style={styles.View_191_196}>
            <Text style={styles.Text_191_196}>
              Security Self Audit Assement{" "}
            </Text>
          </View>
        </View>
        <View style={styles.View_191_197}>
          <View style={styles.View_191_198}>
            <View style={styles.View_191_199}>
              <Text style={styles.Text_191_199}>Controller</Text>
            </View>
          </View>
        </View>
        <View style={styles.View_191_200}>
          <View style={styles.View_191_201}>
            <Text style={styles.Text_191_201}>Operational Visit</Text>
          </View>
        </View>
        <View style={styles.View_191_202}>
          <View style={styles.View_191_203}>
            <Text style={styles.Text_191_203}>
              Perfomance Management Review
            </Text>
          </View>
        </View>
        <View style={styles.View_191_204}>
          <View style={styles.View_191_205}>
            <View style={styles.View_191_206}>
              <Text style={styles.Text_191_206}>Additional Personal</Text>
            </View>
          </View>
        </View>
        <View style={styles.View_191_207}>
          <View style={styles.View_191_208}>
            <Text style={styles.Text_191_208}>Reliever</Text>
          </View>
        </View>
        <View style={styles.View_191_209}>
          <View style={styles.View_191_210}>
            <Text style={styles.Text_191_210}>Training Reguler</Text>
          </View>
        </View>
        <View style={styles.View_191_211}>
          <View style={styles.View_191_212}>
            <Text style={styles.Text_191_212}>Optional Service</Text>
          </View>
        </View>
        <View style={styles.View_191_213}>
          <View style={styles.View_191_214}>
            <Text style={styles.Text_191_214}>Shelter Digital</Text>
          </View>
        </View>
      </View>
    </ScrollView>
